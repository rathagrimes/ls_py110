...
# list of transactions, and returns a list containing only the
# transactions for the specified inventory item.

# input: a numeric transaction id, and a list of transactions (dicts)
# output: a filtered list of transactions
# approach: use a list comprehension to output a filtered version of the input list
